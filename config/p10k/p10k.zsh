...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # nvm                   # node.js version from nvm (https://github.com/nvm-sh/nvm) — replaced by node_version
  ...
  # Context color in SSH without privileges: RED text, no background
  ...
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_SUDO_VISUAL_IDENTIFIER_EXPANSION=
