...
function M.load()
  ...
  set("CobolBreadcrumbProc", { fg = p.status_palette_fg, bg = p.status_palette_bg, bold = true })
  set("CobolBreadcrumbData", { fg = p.tab_active_fg, bg = p.tab_active_bg, bold = true })
  set("CobolBreadcrumbEnv", { fg = p.tab_active_fg, bg = p.type, bold = true })
  set("CobolBreadcrumbId", { fg = p.tab_active_fg, bg = p.constant, bold = true })
